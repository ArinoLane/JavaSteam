...
public class menu extends JFrame implements  MouseListener, ActionListener 
{
    ...
    public menu (String s1UserName, String s2UserPass, String s3UserEmail, JFrame l1) 
    { 
        super("STEAM");
        ...
        this.l1=l1;
        this.s1UserName=s1UserName; //Username
...
//----------------------------------------------------------------------------------------------------
    ...
    public menu (String s1UserName, String s3UserEmail,JFrame l1) //parameter constructor 
    {        
        super("STEAM");
        this.setSize(1024, 768);
        this.setLocation(250,42);
...
public void actionPerformed(ActionEvent ae){
     ...
     if (ae.getSource() == buy0 || ae.getSource() == buy1) 
	{
		 ...
		 {
		 	MStore store1 = new MStore(s1UserName,s2UserPass,s3UserEmail,this);
...
//--------------------------
        ...
        {
            profile p1 = new profile(s1UserName,s2UserPass,s3UserEmail,this);
            p1.setVisible(true);
            this.setVisible(false);
        }
